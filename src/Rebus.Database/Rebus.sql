BEGIN TRANSACTION;
DROP TABLE IF EXISTS "dotnet_migration";
...
CREATE TABLE IF NOT EXISTS "Token" (
	...
	"NameType"	INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "Player" (
	...
	"Wealth"	INTEGER NOT NULL DEFAULT 100,
	CONSTRAINT "PK_Player" PRIMARY KEY("Id" AUTOINCREMENT)
);
INSERT INTO "dotnet_migration" VALUES ('20220328203928_InitialMigration','6.0.3');
INSERT INTO "Token" VALUES ('',0,0),
 ('redo',1048576,0),
 ('reexecute',1048576,0),
 ('repeat',1048576,0),
 ('undo',1048576,0),
