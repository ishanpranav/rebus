...
## References
- The [hexagonal coordinate system](src/Rebus/HexPoint.cs) and the [layout](src/Rebus.Client/Layout.cs) is inspired by and based on [this](https://www.redblobgames.com/grids/hexagons/) article by [Amit Patel](http://www-cs-students.stanford.edu/~amitp/).
