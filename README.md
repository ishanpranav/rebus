...
- The implementation of [Dijkstra\'s algorithm](src/Rebus/Pathfinders/DijkstraPathfinder.cs) and the [A* search algorithm](src/Rebus/Pathfinders/AStarPathfinder.cs) were inspired by and based on [this](https://en.wikipedia.org/wiki/A*_search_algorithm) Wikipedia article.
