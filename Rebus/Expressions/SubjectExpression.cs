// Ishan Pranav's REBUS: SubjectExpression.cs
...
{
    public class SubjectExpression : Expression
    {
        ...
        public SubjectExpression(IEnumerable<IToken> adjectives, IToken substantive)
        {
        ...
        {
            return context.SetSubjectAsync(this._adjectives, this._substantive);
        }
